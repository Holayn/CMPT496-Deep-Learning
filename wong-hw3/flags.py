...
# neurons1 = int(sys.argv[1])
# neurons2 = int(sys.argv[2])
learningRate1 = float(sys.argv[1])
learningRate2 = float(sys.argv[2])
...
flags.DEFINE_float('pre_layer1_learning_rate', learningRate1,
                   'Initial learning rate.')
flags.DEFINE_float('pre_layer2_learning_rate', learningRate2,
                   'Initial learning rate.')
